...
export const metadata: Metadata = {
  ...
  description: "Privacy Policy for nudge.",
};
    ...
    <>
      <main className="mx-auto w-full max-w-3xl px-6 py-20 flex-1">
        ...
        <div className="prose prose-sm max-w-none text-app-muted leading-relaxed space-y-4">
          ...
          <p>
            This Privacy Policy describes how nudge (&quot;we&quot;,
            &quot;us&quot;, or &quot;our&quot;) collects, uses, and shares
            information about you when you use our iOS app and related services.
          </p>
          <p>
            This is a placeholder document. The full Privacy Policy will be
